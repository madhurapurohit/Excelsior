...
<head>
    ...
    <!-- for date in all browser see belown -->
...
$('a[href*="#personal1,#income1,#loan1,#qualification1,#referee1"]')
...
<!-- end of personal Information -->
		...
		<div class="full_income">
			...
			<div class="col-md-4 col-xs-12"><br>
				<input type="text" class="fa fa-" required="1" name="location" placeholder="Enter Location" >
			</div>
			<div class="col-md-2 col-xs-12"><br>
				<p class="textname">Property Name</p> 
			</div>
			<div class="col-md-4 col-xs-12"><br>
				<input type="text" class="fa fa-" name="pname" required="1" placeholder="Specify Property Name" >
			</div>
			</div>
			...
			<div class="col-md-4 col-xs-12">
				<input type="text" class="fa fa-" required="1" name="estimatedamount" >
			</div>
			<div class="col-md-2 col-xs-12">
				<p class="textname">Type of Employement</p> 
			</div>
			<div class="col-md-4 col-xs-12">
				<select class="fa fa-" name="typeofemp" required="1">
			...
			<div class="col-md-4 col-xs-12"><br>
				<input type="text" class="fa fa-" name="interest" required="1" value="8.5" readonly>
			</div>
			</div><br>&nbsp;
		...
		<div class="col-md-12">
			...
			<div class="col-md-4 col-xs-12"><br>
				<input type="text" class="fa fa-" name="pannumber" placeholder="Enter PAN Card Number"  required="1">
			</div>
			<div class="col-md-2 col-xs-12"><br>
			...
			<div class="col-md-4 col-xs-12"><br>
				<input type="text" class="fa fa-" name="aadharnumber" placeholder="Enter Aadhar Card Number"  required="1">
			</div>
			<div class="col-md-2 col-xs-12"><br>
			...
			<div class="col-md-4 col-xs-12"><br>
				<input type="text" class="fa fa-" name="voteridnumber" placeholder="Voter Id Card Number"  required="1">
			</div>
			<div class="col-md-2 col-xs-12"><br>
			...
			<div class="col-md-2 col-xs-12"><br>
				<p class="textname">Upload Letter of Agreemrnt</p>
			</div>
			<div class="col-md-4 col-xs-12"><br>
