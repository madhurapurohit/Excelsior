...
<head>
  <title>Customer Login</title>
    ...
    <script src="js/EligibilityCalculator.js"></script>
...
<div class="col-md-12 col-xs-12 bg-text">
        ...
        <h2 style="text-align: center">Eligibility Calculator</h2>
        
          <table  align=center width="100%" border="0" cellpadding="5" cellspacing="" id=emi_calc >
          <form name=EMI>
             
              <td>Monthly income : </td>
              <td><input placeholder="Please enter your monthly income" name="income" id="income" type="number" required autofocus></td>
          </tr>

          <tr>
              <td> </td>
              <td><input type="button" id="calculate" style="vertical-align:middle" name="calculate" value="Calculate" onclick="CalculateEligibility()"></td>
          </tr>
          <tr>
              <td>Eligibility </td>
              <td> <input placeholder="Eligibility"  type="number" name="cal" id="cal" readonly></td>
          </tr>
